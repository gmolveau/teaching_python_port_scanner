"""
exemple de l'utilisation de argparse pour faire un cli avec plusieurs sous-commandes

ici un cli qui tente de reproduire les commandes git clone, et git commit
"""
